...
public class task extends JFrame{
		...
		private JLabel nmlbl1,nmlbl2,nmlbl3,nmlbl4,nmlbl5,nmlbl6,nmlbl7,nmlbl8,nmlbl9,passlabel;
	...
	task(){
		...
		nmlbl8 = new JLabel("Gender:");
		nmlbl9 = new JLabel("Secuirty Question:  What is your pet name?");
	   ...
	   p2=new JRadioButton("female");
		...
		nmlbl9.setBounds(400,120,900,75);
		
		p1.setBounds(200,320,70,40);
		p2.setBounds(280,320,70,40);
		...
		txtfld6.setBounds(500,75,100,30);
		txtfld7.setBounds(500,175,100,30);
